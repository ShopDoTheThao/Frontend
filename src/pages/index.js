...
import { useClockCountDown } from '../useEffect/clockCountDown';
...
function Home() {
    ...
    return (
        <>
            {/* start banner Area */}
            <section className="banner-area" style={{height: 650}}>
                <div className="container">
                    <div className="row fullscreen align-items-center justify-content-start" style={{height: 650}}>
                        <div className="col-lg-12">
                            <div className="active-banner-slider owl-carousel owl-theme owl-loaded">
                                {/* single-slide */}
                                <div className="row single-slide align-items-center d-flex" style={{display: 'none !important'}}>
